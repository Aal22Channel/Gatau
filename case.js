...
const banRep = () => {
Kyuu.sendMessage(m.chat, {
text:`Sorry you jave been banned, please chat @${creator.split("@")[0]} to unban`,
mentions: [creator],
},
{
quoted:m
...
`
    ...
    await adris.sendMessage(m.chat, listMessage)

    await adris.sendMessage(nomornya, {
...
if (!u) return
let d = (await adris.onWhatsApp(u.split`@`[0]))[0] || {}
...
=====================================
`
adris.sendMessage(u,{image: {url: akunlo}, caption: ctf }, { quoted: adris.chat })
